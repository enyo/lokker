...
$$.main_anon = {"": "Closure;",
  call$1: function(element) {
    ...
    t1.$indexSet(t1, t2.get$attributes(element)._element.getAttribute("href"), element);
    t2 = t2.get$onClick(element);
    $._EventStreamSubscription$(t2._target, t2._eventType, new $.main__anon(), t2._useCapture);
  }
};
...
$$.showPage_anon = {"": "Closure;",
  call$1: function(element) {
    var t1 = $.get$classes$x($.get$parent$x(element));
...
$$.Router = {"": "Object;_handlers<,useFragment",
  ...
  _getUrl$1: function(path) {
    var matches = $.WhereIterable$(this._handlers.get$keys(), new $.Router__getUrl_anon(path));
  ...
  listen$1$ignoreClick: function(ignoreClick) {
    ...
    if (!ignoreClick) {
      t1 = $.Window_methods.get$onClick(window);
      $._EventStreamSubscription$(t1._target, t1._eventType, new $.Router_listen_anon1(this), t1._useCapture);
    }
  },
  listen$0: function() {
...
$$.UrlPattern = {"": "Object;pattern,_regex,_hasFragment,_baseRegex",
  ...
  matches$1: function(_, str) {
    return this._liblib3$_matches$2(this.get$regex(), str);
  },
  _liblib3$_matches$2: function(p, str) {
    ...
    t1 = iter._re;
    t2 = iter._str;
    iter._liblib4$_current = t1.firstMatch$1(t2);
    if (iter._liblib4$_current != null) {
      match = iter.get$current();
      if (match.start === 0)
        if (match.end === $.get$length$asx(str)) {
          iter._liblib4$_current = t1.firstMatch$1(t2);
          t1 = iter._liblib4$_current == null;
        } else
          t1 = false;
      else
        t1 = false;
...
$$.AnchorElement = {"": "Element;hash=,host=,name=,pathname=,target=",
  toString$0: function(receiver) {
...
$$.Element = {"": "Node;$$dom_children:children=,id=,title=",
...
$.showPage = function(path) {
  ...
  t1 = $.get$pathElements();
  t1 = $.get$classes$x($.get$parent$x(t1.$index(t1, path)));
  t1.add$1(t1, "active");
...
//@ sourceMappingURL=app.app.dart.js.map
